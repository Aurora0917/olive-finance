...
//         interest_rate: TradingUtils.getSolBorrowRate(solCustodyData.tokenLocked.toNumber(), solCustodyData.tokenOwned.toNumber()),
...
//         interest_rate: TradingUtils.getUsdcBorrowRate(usdcCustodyData.tokenLocked.toNumber(), usdcCustodyData.tokenOwned.toNumber()),
